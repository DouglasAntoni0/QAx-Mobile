...
## Sobre
- **Tecnologias principais:** Robot Framework, Appium.
- **Contexto:** Prática educacional de curso de automação.
- O código será constantemente refatorado e expandido conforme o avanço nos módulos de estudo.

Agradeço a visita e sinta-se à vontade para acompanhar a evolução dos scripts!
